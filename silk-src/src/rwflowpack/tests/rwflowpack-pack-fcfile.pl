...
#
#
# RCSIDENT("$SiLK: rwflowpack-pack-fcfile.pl 23e62811e29c 2016-11-16 15:30:29Z mthomas $")
...
close $fh
    or die "$NAME: Cannot close $fcfile: $!\n";
...
verify_archived_files("$tmpdir/archive", $fcfile);
