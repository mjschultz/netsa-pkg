...
#######################################################################
# $SiLK: flowcap-daemon.py efd886457770 2017-06-21 18:43:23Z mthomas $
#######################################################################
...
def main():
    ...
    dirobj.dirs = ['destination', 'error', 'archive', 'processing', 'log']
    dirobj.create_dirs()
    ...
    started = re.compile("Started Stream Input Mode")
