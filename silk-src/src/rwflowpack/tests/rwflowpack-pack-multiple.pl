...
#
#
# RCSIDENT("$SiLK: rwflowpack-pack-multiple.pl 23e62811e29c 2016-11-16 15:30:29Z mthomas $")
...
my $cmd = join " ", ("$SiLKTests::PYTHON $srcdir/tests/rwflowpack-daemon.py",
                     ...
                     "--pdu 50000,$host,$port1",
                     "--pdu 50000,$host,$port2",
                     "--limit=1103752",
                     "--",
                     $config_lua,
    );
...
verify_empty_dirs($tmpdir, qw(error incoming incoming2 incremental processing));
