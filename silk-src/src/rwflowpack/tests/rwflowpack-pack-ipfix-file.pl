...
#
#
# RCSIDENT("$SiLK: rwflowpack-pack-ipfix-file.pl 23e62811e29c 2016-11-16 15:30:29Z mthomas $")
...
unlink $ipfixdata;
system "/bin/cp", $file{data_ipfix}, $ipfixdata
