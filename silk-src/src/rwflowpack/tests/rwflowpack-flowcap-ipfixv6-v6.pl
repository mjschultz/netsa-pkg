...
#
#
# RCSIDENT("$SiLK: rwflowpack-flowcap-ipfixv6-v6.pl 26d0a9883169 2016-09-02 17:14:38Z mthomas $")
...
my $cmd = join " ", ("$SiLKTests::PYTHON $srcdir/tests/flowcap-daemon.py",
                     "--basedir=$tmpdir",
                     "--tcp $file{v6data_ipfix},$host,$port",
                     "--limit=501876",
                     "--",
                     $config_lua,
    );
...
exit check_md5_output('927f873c05050bc9d8e28f4831bd0110', $cmd);
