...
the content of the flow as reported in the applabel field of B<yaf>
...
B<rwset(1)>, B<rwuniq(1)>, B<sensor.conf(5)>, B<silk(7)>, B<zlib(3)>

=cut

$SiLK: rwaggbag.pod 19097c33c9cb 2017-03-24 19:36:51Z mthomas $
