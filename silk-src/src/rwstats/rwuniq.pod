...
router SNMP input interface or vlanId
...
B<--fields>.  For example, C<Distinct:sPort>
...
B<rwfilter(1)>, B<rwbag(1)>, B<rwbagcat(1)>, B<rwcut(1)>, B<rwset(1)>,
...
$SiLK: rwuniq.pod e1efec571078 2017-06-26 22:13:22Z mthomas $
