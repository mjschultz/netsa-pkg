...
environment variable.  Version 5 was added in S<SiLK 3.14>.  As of
S<SiLK 4.0>, the default record versions are 4 for IPv4 and 5 for
IPv6.

=cut

$SiLK: rwsetbuild.pod 5036d9fcc2e7 2017-06-26 20:31:01Z mthomas $
