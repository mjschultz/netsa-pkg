...
not specified, the SILK_IP_FORMAT environment variable is checked for
a format.  If it is empty or contains an invalid format, IPs are
printed in the canonical format.  The I<FORMAT> is one of:
...
$SiLK: rwpmapcat.pod 57cd46fed37f 2017-03-13 21:54:02Z mthomas $
