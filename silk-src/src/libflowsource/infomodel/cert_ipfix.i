static fbInfoElement_t infomodel_array_static_cert_ipfix[] = {
    ...
    FB_IE_INIT_FULL("DNS_A_RECORD", 6871, 305, FB_IE_VARLEN, FB_IE_DEFAULT, 0, 0, FB_SUB_TMPL_LIST, NULL),
    FB_IE_INIT_FULL("DNS_AAAA_RECORD", 6871, 306, FB_IE_VARLEN, FB_IE_DEFAULT, 0, 0, FB_SUB_TMPL_LIST, NULL),
