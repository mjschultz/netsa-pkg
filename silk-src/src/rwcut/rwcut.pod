...
the key in B<--fields>.  The switch may be repeated to load Lua code
from multiple files.
...
The B<--icmp-type-and-code> switch was removed in the SiLK 4.0.0
release.  Use the B<iType> and B<iCode> fields to print the ICMP type
and ICMP code, respectively.
...
B<pysilk(3)>, B<silk(7)>, B<yaf(1)>, B<dlopen(3)>, B<tzset(3)>,
B<environ(7)>

=cut

$SiLK: rwcut.pod 6ced2b9cf93b 2017-06-26 21:15:05Z mthomas $
