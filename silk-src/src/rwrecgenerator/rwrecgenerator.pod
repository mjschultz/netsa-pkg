...
When this switch is not specified, the SILK_IP_FORMAT environment
variable is checked for a format.  If it is empty or contains an
invalid format, IPs are printed in the canonical format.  The
I<FORMAT> is one of:
...
$SiLK: rwrecgenerator.pod 6d21d1f3d455 2017-06-28 16:32:15Z mthomas $
