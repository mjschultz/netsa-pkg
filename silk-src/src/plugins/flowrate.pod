...
flow, giving the average rate across the flow.  When the flow's
reported duration is zero, a duration of one second is assumed (that
is, the count is used directly).
...
$SiLK: flowrate.pod 3a8f972758a1 2014-07-19 15:15:27Z mthomas $
