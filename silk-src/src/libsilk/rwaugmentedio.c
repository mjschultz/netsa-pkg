...
RCSIDENT("$SiLK: rwaugmentedio.c efd886457770 2017-06-21 18:43:23Z mthomas $");
...
#define FILE_FORMAT "FT_RWAUGMENTED"
    ...
    switch (skHeaderGetRecordVersion(hdr)) {
      case 5:
        stream->silkflow.unpack = &augmentedioRecordUnpack_V5;
        stream->silkflow.pack   = &augmentedioRecordPack_V5;
        break;
      case 4:
        stream->silkflow.unpack = &augmentedioRecordUnpack_V4;
        stream->silkflow.pack   = &augmentedioRecordPack_V4;
        break;
      case 3:
      case 2:
      case 1:
        ...
        stream->silkflow.unpack = &augmentedioRecordUnpack_V1;
        stream->silkflow.pack   = &augmentedioRecordPack_V1;
        break;
      case 0:
      default:
    ...
    stream->rec_len = augmentedioGetRecLen(skHeaderGetRecordVersion(hdr));
