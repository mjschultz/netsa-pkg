...
flow file contains flows in multiple directions.
...
or from files generated by a previous run of B<rwflowpack>,
converts the data to the SiLK
flow record format, categorizes the flow records according to rules
loaded from a packing-logic Lua configuration file, and writes the
...
processing by another instance of B<rwflowpack>.
...
$SiLK: silk.pod cdb00b7f134a 2017-06-23 21:13:05Z mthomas $
