...
Do not copy sidecar fields from the source file(s) to the output
file.  The default is to copy the sidecar fields.
...
$SiLK: rwcat.pod d1637517606d 2017-06-23 16:51:31Z mthomas $
