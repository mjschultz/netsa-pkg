...
prefix map file, and specify the Bag's key as C<sip-pmap:>I<MAPNAME>,
where I<MAPNAME> is either the map-name stored in the prefix map file
...
B<rwfilter(1)>, B<rwnetmask(1)>, B<rwpmapbuild(1)>, B<rwuniq(1)>,
B<ccfilter(3)>, B<sensor.conf(5)>, B<silk(7)>, B<zlib(3)>

=cut

$SiLK: rwbag.pod 57cd46fed37f 2017-03-13 21:54:02Z mthomas $
