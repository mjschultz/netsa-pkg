...
textual input.  Either B<--set-input> or B<--bag-input> must be
provided to specify the type of input; give the switch as argument of
C<stdin> or C<-> to read from the standard input.
...
$SiLK: rwbagbuild.pod 5f2d30e80a6f 2016-03-30 22:09:49Z mthomas $
