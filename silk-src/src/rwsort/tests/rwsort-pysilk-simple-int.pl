...
# TEST: ./rwsort --python-file=../../tests/pysilk-plugin.py --fields=lower_port_simple ../../tests/data.rwf | ../rwuniq/rwuniq --python-file=../../tests/pysilk-plugin.py --fields=lower_port_simple --values=bytes --presorted-input
